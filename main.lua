...
--// Human-like Automation Variables
local humanAuto = {
    lastCast = 0,
    lastReel = 0,
    lastShake = 0,
    ...
    breakDuration = 0,
    patterns = {
        castDelays = {2.1, 2.8, 3.2, 2.5, 3.7, 2.9, 3.1, 2.3},
        reelDelays = {0.8, 1.2, 0.9, 1.1, 1.3, 0.7, 1.0, 1.4},
...
local function getPatternDelay(actionType)
    ...
    if patterns then
        ...
        humanAuto.currentPattern = (humanAuto.currentPattern % #patterns) + 1
        return delay * humanAuto.tirednessFactor
    end
    return 1.0
end
