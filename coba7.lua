...
-- Rod and Zone data loaded
-- Number of Zones: {number will be calculated}
-- Number of Rods: {number will be calculated}
...
-- UI Windows initialization complete

Automation:Section('⚙️ Basic Settings')
...
Automation:Button('Shake: Fast(50) | Normal(150) | Safe(300)', function()
    local presets = {50, 150, 300}
    local current = flags['shakedelayrange'] or 150
    local nextIndex = 1
    ...
    flags['shakedelayrange'] = presets[nextIndex]
    message("Shake: " .. presets[nextIndex] .. "ms", 1)
end)
...
Automation:Button('Reset Shake Settings', function()
    ...
    message("Shake reset!", 1)
end)

-- REEL SECTION (kompak untuk visibility)
